      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up">
            ...
            <div>
              <h4 class="title">Overnight</h4>
              <p class="description">Overnight Express is a premier courier company committed to providing swift and reliable shipping solutions.</p>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex " data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              <h4 class="title">Same Day Dilevery</h4>
